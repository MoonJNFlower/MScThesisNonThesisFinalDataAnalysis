# M.Sc Thesis and Non-Thesis Research Data Analysis Report
...
The dataset contains **788** clean records of M.Sc research projects spanning from academic year **1985-1986** to **2022-2023**.

---

## 1. Research Project Types Overview

* **Thesis Projects**: **636** (80.7%)
* **Non-Thesis Projects**: **152** (19.3%)
...
| :--- | :---: | :---: | :---: | :---: |
| **Fish** | 154 | 50 | 204 | 25.9% |
| **Insects** | 168 | 25 | 193 | 24.5% |
| **Birds** | 83 | 16 | 99 | 12.6% |
| **Mammals (non-primate)** | 57 | 18 | 75 | 9.5% |
| **Unknown** | 36 | 15 | 51 | 6.5% |
| **Primates** | 42 | 6 | 48 | 6.1% |
| **Ecology & Conservation** | 39 | 9 | 48 | 6.1% |
| **Reptiles & Amphibians** | 21 | 9 | 30 | 3.8% |
| **Invertebrates (non-insect)** | 15 | 4 | 19 | 2.4% |
| **Plankton & Benthos** | 10 | 0 | 10 | 1.3% |
| **Micro-organisms / Toxicology** | 6 | 0 | 6 | 0.8% |
| **Mixed Taxa** | 4 | 0 | 4 | 0.5% |
| **Other / Miscellaneous** | 1 | 0 | 1 | 0.1% |
...
* **Unpublished** projects comprise the largest category (**658** projects).
...
| :--- | :---: | :---: | :---: |
| **Published** | 55 | 2 | 57 |
| **Unpublished** | 517 | 141 | 658 |
| **Conference Paper** | 11 | 1 | 12 |
| **Preprint** | 2 | 0 | 2 |
| **Unclear/Confusion** | 24 | 0 | 24 |
| **Missing/Unknown** | 27 | 7 | 34 |

### Publication Rates
*(Defined as Published + Conference Paper divided by total resolved entries)*
* **Thesis Publication Rate**: 11.3%
* **Non-Thesis Publication Rate**: 2.1%
* **Overall Research Dissemination Rate**: 9.5%

---

## 5. Study Duration (Time Required)

We analyzed the duration of research projects based on the entries in the "Time Required" column. Note that **422** out of **788** records did not have a parseable duration.

* **Thesis Average Duration**: **9.8 months** (Median: **10.0 months**)
* **Non-Thesis Average Duration**: **N/A** (Median: **N/A**)
